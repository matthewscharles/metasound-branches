	...
	public:
		...
		static const FNodeClassMetadata& GetNodeInfo()
		{
			auto CreateMetadata = []() -> FNodeClassMetadata
			{
				...
				Metadata.ClassName = { TEXT("UE"), TEXT("AudioNotEqualToAudio"), TEXT("Audio") };
				Metadata.MajorVersion = 1;
				Metadata.MinorVersion = 0;
				Metadata.DisplayName = LOCTEXT("AudioNotEqualToAudioNodeDisplayName", "!=");
				Metadata.Description = LOCTEXT("AudioNotEqualToAudioNodeDesc", "Outputs audio signal of 1 if input != threshold.");
		...
		static TUniquePtr<IOperator> CreateOperator(const FBuildOperatorParams& InParams, FBuildResults& OutErrors)
		{
			...
			return MakeUnique<FAudioNotEqualToAudioOperator>(InParams.OperatorSettings, InAudio, InThreshold);
		}
