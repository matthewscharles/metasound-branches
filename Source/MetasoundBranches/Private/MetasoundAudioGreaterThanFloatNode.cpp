...
namespace Metasound
{
	...
	{
	public:
		FAudioGreaterThanFloatNode(const FNodeInitData& InitData)
			: FNodeFacade(InitData.InstanceName, InitData.InstanceID, TFacadeOperatorClass<FAudioGreaterThanFloatOperator>())
		{}
	};
