...
#include "MetasoundBranches/Public/MetasoundAudioGreaterThanFloatNode.h"
...
#define LOCTEXT_NAMESPACE "MetasoundAudioGreaterThanFloatNode"
...
namespace Metasound
{
	...
	{
	public:
		FAudioGreaterThanFloatOperator(
		...
		static const FNodeClassMetadata& GetNodeInfo()
		{
			auto CreateMetadata = []() -> FNodeClassMetadata
			{
				...
				Metadata.ClassName = { TEXT("UE"), TEXT("Greater"), TEXT("Float") };
				Metadata.MajorVersion = 1;
				Metadata.MinorVersion = 0;
				Metadata.DisplayName = LOCTEXT("AudioGreaterThanFloatNodeDisplayName", "Greater (Audio > Float)");
				Metadata.Description = LOCTEXT("AudioGreaterThanFloatNodeDesc", "Outputs 1.0 where In A is greater than In B, else 0.0.");
	...
	class FAudioGreaterThanFloatNode : public FNodeFacade
	{
	public:
				static FNodeClassMetadata CreateNodeClassMetadata()
		{
		    return FAudioGreaterThanFloatOperator::GetNodeInfo();
		}
		FAudioGreaterThanFloatNode(FNodeData InitData)
			: FNodeFacade(InitData, MakeShared<const FNodeClassMetadata>(FAudioGreaterThanFloatOperator::GetNodeInfo()), TFacadeOperatorClass<FAudioGreaterThanFloatOperator>())
		{}
	};

	METASOUND_REGISTER_NODE(FAudioGreaterThanFloatNode);
}
