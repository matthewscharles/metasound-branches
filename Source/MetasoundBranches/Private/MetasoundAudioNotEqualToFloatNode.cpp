...
namespace Metasound
{
	...
	public:
		...
		static const FNodeClassMetadata& GetNodeInfo()
		{
			auto CreateMetadata = []() -> FNodeClassMetadata
			{
				...
				Metadata.ClassName = { TEXT("UE"), TEXT("AudioNotEqualToFloat"), TEXT("Audio") };
				Metadata.MajorVersion = 1;
				Metadata.MinorVersion = 0;
				Metadata.DisplayName = LOCTEXT("AudioNotEqualToFloatNodeDisplayName", "!=");
				Metadata.Description = LOCTEXT("AudioNotEqualToFloatNodeDesc", "Outputs audio signal of 1 if input != threshold.");
		...
		static TUniquePtr<IOperator> CreateOperator(const FBuildOperatorParams& InParams, FBuildResults& OutErrors)
		{
			...
			return MakeUnique<FAudioNotEqualToFloatOperator>(InParams.OperatorSettings, InAudio, InThreshold);
		}
	...
	{
	public:
		FAudioNotEqualToFloatNode(const FNodeInitData& InitData)
			: FNodeFacade(InitData.InstanceName, InitData.InstanceID, TFacadeOperatorClass<FAudioNotEqualToFloatOperator>())
		{}
	};
