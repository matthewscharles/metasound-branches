...
namespace Metasound
{
    ...
    public:
        ...
        FWrapAudioNode(FNodeData InitData)
            : FNodeFacade(InitData, MakeShared<const FNodeClassMetadata>(FWrapOperator::GetNodeInfo()), TFacadeOperatorClass<FWrapOperator>())
        {
        }
    };
