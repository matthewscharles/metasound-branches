	...
	public:
		...
		static const FNodeClassMetadata& GetNodeInfo()
		{
			auto CreateMetadata = []() -> FNodeClassMetadata
			{
				...
				Metadata.ClassName = { TEXT("UE"), TEXT("AudioLessThanOrEqualToAudio"), TEXT("Audio") };
				Metadata.MajorVersion = 1;
				Metadata.MinorVersion = 0;
				Metadata.DisplayName = LOCTEXT("AudioLessThanOrEqualToAudioNodeDisplayName", "<=");
				Metadata.Description = LOCTEXT("AudioLessThanOrEqualToAudioNodeDesc", "Outputs audio signal of 1 if input <= threshold.");
		...
		static TUniquePtr<IOperator> CreateOperator(const FBuildOperatorParams& InParams, FBuildResults& OutErrors)
		{
			...
			return MakeUnique<FAudioLessThanOrEqualToAudioOperator>(InParams.OperatorSettings, InAudio, InThreshold);
		}
