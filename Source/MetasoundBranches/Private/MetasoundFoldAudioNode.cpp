...
namespace Metasound
{
    ...
    public:
        ...
        {
            return FFoldOperator::GetNodeInfo();
        }
        FFoldAudioNode(FNodeData InitData)
            : FNodeFacade(InitData, MakeShared<const FNodeClassMetadata>(FFoldOperator::GetNodeInfo()), TFacadeOperatorClass<FFoldOperator>())
        {
        }
    };
