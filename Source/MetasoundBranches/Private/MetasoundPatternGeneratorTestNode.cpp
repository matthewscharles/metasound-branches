...
#include "MetasoundBranches/Public/MetasoundPatternGeneratorTestNode.h"
...
namespace Metasound
{
    namespace PatternGeneratorTestNodeVertexNames
    {
    ...
    class FPatternGeneratorTestOperator : public TExecutableOperator<FPatternGeneratorTestOperator>
    {
    public:
        FPatternGeneratorTestOperator(const FOperatorSettings& InSettings,
        ...
        {
            using namespace PatternGeneratorTestNodeVertexNames;
        ...
        static const FNodeClassMetadata& GetNodeInfo()
        {
            auto CreateNodeClassMetadata = []() -> FNodeClassMetadata
            {
                ...
                Metadata.ClassName = { TEXT("Branches"), TEXT("PatternGeneratorTest"), TEXT("Audio") };
                Metadata.MajorVersion = 1;
                Metadata.MinorVersion = 0;
                Metadata.DisplayName = LOCTEXT("PatternGeneratorTestDisplayName", "Pattern Generator Basic");
                Metadata.Description = LOCTEXT("PatternGeneratorTestDesc", "Generates a random float at a specified interval.");
        ...
        {
            using namespace PatternGeneratorTestNodeVertexNames;
            InOutVertexData.BindReadVertex(METASOUND_GET_PARAM_NAME(InputInterval), Interval);
        ...
        static TUniquePtr<IOperator> CreateOperator(const FBuildOperatorParams& InParams, FBuildResults& OutErrors)
        {
            ...
            return MakeUnique<FPatternGeneratorTestOperator>(InParams.OperatorSettings, IntervalRef, ActiveRef);
        }
    ...
    class FPatternGeneratorTestNode : public FNodeFacade
    {
    public:
                static FNodeClassMetadata CreateNodeClassMetadata()
        {
            return FPatternGeneratorTestOperator::GetNodeInfo();
        }
        FPatternGeneratorTestNode(FNodeData InitData)
            : FNodeFacade(InitData, MakeShared<const FNodeClassMetadata>(FPatternGeneratorTestOperator::GetNodeInfo()), TFacadeOperatorClass<FPatternGeneratorTestOperator>())
        {
        }
    };

    METASOUND_REGISTER_NODE(FPatternGeneratorTestNode);
}
