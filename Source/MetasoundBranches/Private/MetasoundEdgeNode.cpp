...
namespace Metasound
{
    ...
    public:
        ...
        {
            return FEdgeOperator::GetNodeInfo();
        }
        FEdgeNode(FNodeData InitData)
            : FNodeFacade(InitData, MakeShared<const FNodeClassMetadata>(FEdgeOperator::GetNodeInfo()), TFacadeOperatorClass<FEdgeOperator>())
        {
        }
    };
