...
namespace Metasound
{
    ...
    public:
        ...
        {
            return FEdoNodeOperator::GetNodeInfo();
        }
        FEdoNode(FNodeData InitData)
            : FNodeFacade(InitData, MakeShared<const FNodeClassMetadata>(FEdoNodeOperator::GetNodeInfo()), TFacadeOperatorClass<FEdoNodeOperator>())
        {
        }
    };
