...
namespace Metasound
{
	namespace AudioGreaterThanOrEqualToFloatNodeVertexNames
	{
		...
		METASOUND_PARAM(InputSignalB, "InB", "Float to compare against.");
	...
	public:
		...
		static const FNodeClassMetadata& GetNodeInfo()
		{
			auto CreateMetadata = []() -> FNodeClassMetadata
			{
				...
				Metadata.ClassName = { TEXT("UE"), TEXT("GreaterThanEqualFloat"), TEXT("Audio") };
				Metadata.MajorVersion = 1;
				Metadata.MinorVersion = 0;
				Metadata.DisplayName = LOCTEXT("AudioGreaterThanOrEqualToFloatNodeDisplayName", "Greater Than Or Equal (Audio >= Float)");
				Metadata.Description = LOCTEXT("AudioGreaterThanOrEqualToFloatNodeDesc", "Outputs 1.0 where InA is greater than or equal to InB, else 0.0.");
