...
namespace Metasound
{
	...
	{
		METASOUND_PARAM(InputSignalA, "InA", "Audio signal to compare.");
	...
	public:
		...
		static const FNodeClassMetadata& GetNodeInfo()
		{
			auto CreateMetadata = []() -> FNodeClassMetadata
			{
				...
				Metadata.ClassName = { TEXT("UE"), TEXT("LessThanEqualFloat"), TEXT("Audio") };
				Metadata.MajorVersion = 1;
				Metadata.MinorVersion = 0;
				Metadata.DisplayName = LOCTEXT("AudioLessThanOrEqualToFloatNodeDisplayName", "Less Than Or Equal (Audio <= Float)");
