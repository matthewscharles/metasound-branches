...
| [`Dust`](https://matthewscharles.github.io/metasound-branches/Dust.html) | Generators | Generate randomly timed impulses (unipolar or alternating polarity per impulse) with density control and audio-rate modulation. |
